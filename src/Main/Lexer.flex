...
( "Receive" | "DeviceType" | "Enable" | "True" | "FaceCheck" | "IsOff" | "SmartCamera" | "Program" | "This" | "IsOn" | "Doorbell" | "Int" | "Text" | "Float" | "Bool" | "Display" | "For" | "While" | "If" | "Else" | "When" | "Default" | "Home" | "Initialize" | "PortA" | "PortB" | "PortC" | "PortD" | "Enable" | "Room" | "New" |"Temp" | "GetTemp" | "Ac" | "Set" | "Start" | "Shutdown" | "Light" | "Off" | "On" | "LightRGB" | "LightMode" | "Color" | "Door" | "Open" | "Close" | "Lock" | "Unlock" | "Window" | "IsOpen" | "IsClose" | "IsLock" |"IsUnlock" | "UnlockAt" | "LockAt" | "Camera" | "Record" | "StopRec" | "Move" | "IsMove" | "Alarm" | "Device" | "IsIn" | "IsOut" ) {lexeme=yytext(); linea = yyline; columna = yycolumn; Main.listaCompLexico.add("Palabra reservada"); Main.listaLexemas.add(lexeme); Main.listaLineaLexemas.add(linea+1); return Palabra_reservada;}
