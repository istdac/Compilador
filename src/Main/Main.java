            ...
            public void insertString (int offset, String str, AttributeSet a) throws BadLocationException {
                ...
                while (wordR <= after) {
                    if (wordR == after || String.valueOf(text.charAt(wordR)).matches("(\\W)")) {     
                        if((text.substring(wordL, wordR).matches("((\\n)|(\\s))* (Obj|Int|Text|Bool|Float|Receive|DeviceType|Else|True|Int|Text|Float|Bool|Display|For|While|If|Else|When|Default|PortA|PortB|PortC|PortD|New)"))){
                            setCharacterAttributes(wordL, wordR - wordL,attrBlue, false); 
                            contador++;                       
//                        }else if((text.substring(wordL, wordR).matches("((\\n)|(\\s))*(alex|asin|asem)"))){
//                            setCharacterAttributes(wordL, wordR - wordL,attrBlue, false); 
//                            contador++;
                        }else if (text.substring(wordL, wordR).matches("(\\W)+ (Obj|Int|Text|Bool|Float|Receive|DeviceType|Else|True|Int|Text|Float|Bool|Display|For|While|If|Else|When|Default|PortA|PortB|PortC|PortD|New)")&&(contador==0)){
...
//                            setCharacterAttributes(wordL+1, wordR - wordL,attrBlue, false);
            ...
            public void remove (int offs, int len) throws BadLocationException {
                ...
                if (text.substring(before, after).matches("(\\W)+(Obj|Int|Text|Bool|Float|Receive|DeviceType|Else|True|Int|Text|Float|Bool|Display|For|While|If|Else|When|Default|PortA|PortB|PortC|PortD|New)")) {
                    setCharacterAttributes(before+1, after - before, attrBlue, false);  
//                }else if (text.substring(before, after).matches("(\\W)+(alex|asin|asem)")) {
//                    setCharacterAttributes(before+1, after - before, attrBlue, false);  
                }else if (text.substring(before, after).matches("(\\W)* (Obj|Int|Text|Bool|Float|Receive|DeviceType|Else|True|Int|Text|Float|Bool|Display|For|While|If|Else|When|Default|PortA|PortB|PortC|PortD|New)")) {
...
//        tablaElementos.getColumnModel().getColumn(0).setPreferredWidth(4);
    ...
    private void initComponents() {
        ...
        menubtnUndo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.CTRL_MASK));
        ...
        menubtnRedo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y, java.awt.event.InputEvent.CTRL_MASK));
        ...
        menubtnBuscar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.CTRL_MASK));
        ...
        menubtnGoto.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_T, java.awt.event.InputEvent.CTRL_MASK));
        ...
        menubtnSel.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_E, java.awt.event.InputEvent.CTRL_MASK));
        ...
        menuTVar.setToolTipText("");
        menuTVar.setAutoscrolls(true);
